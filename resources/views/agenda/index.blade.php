@extends('layouts.v1')
@section('title') Data agenda @endsection
@section('content')
...
<script>
...

                        {
                                    ...
                                    render: function(value, param, data) {
                                        return '<div class="btn-group">' +
                                            '<a class="btn btn-sm btn-primary" href="/admin/agenda/' + value +
   ...
   function deleteConfirm(id) {
            swal({
                    title: "Kamu Yakin ?",
                    text: "akan menghapus agenda ini !",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((dt) => {
                    if (dt) {
                        window.location.href = "{{ url('admin/agenda') }}/" + id + "/delete";
                    }
                });
        }
  </script>
