                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('program.update',[$data->id]) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <img src="{{asset('photo_program/'.$data->image)}}" border="0" width="150" class="img-rounded" align="center" /><br/>
                                ...
                                <div class="form-group">
                                    <img src="{{asset('photo_program/'.$data->logo)}}" border="0" width="150" class="img-rounded" align="center" /><br/>
                                    <label for="agent">Image</label>
                                    <input type="file" name="logo"
                                        class="form-control  @error('logo') is-invalid @enderror"
                                        placeholder="Image" value="{{ old('logo',$data->logo) }}">
                                    @error('logo')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
